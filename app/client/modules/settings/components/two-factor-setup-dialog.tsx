				...
				{setupStep === "password" && (
					<form onSubmit={handleEnable2FA}>
						<DialogHeader>
							...
							<DialogDescription>{t("settings.twoFactor.setup.passwordStep.description")}</DialogDescription>
						</DialogHeader>
				...
				{setupStep === "qr" && totpUri && (
					<>
						<DialogHeader>
							...
							<DialogDescription>{t("settings.twoFactor.setup.qrStep.description")}</DialogDescription>
						</DialogHeader>
						<div className="space-y-4 py-4">
				...
				{setupStep === "verify" && (
					<>
						<DialogHeader>
							...
							<DialogDescription>{t("settings.twoFactor.setup.verifyStep.description")}</DialogDescription>
						</DialogHeader>
						<div className="space-y-4 py-4">
