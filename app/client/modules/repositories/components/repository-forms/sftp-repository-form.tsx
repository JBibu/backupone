			...
			<FormField
				...
				render={({ field }) => (
					<FormItem>
						...
						<FormControl>
							<Textarea {...field} placeholder={t("repositories.sftpForm.privateKeyPlaceholder")} />
						</FormControl>
				...
				render={({ field }) => (
					<FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
						<div className="space-y-0.5">
							...
							<FormDescription>{t("repositories.sftpForm.skipHostKeyCheckDescription")}</FormDescription>
						</div>
						<FormControl>
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormDescription>{t("repositories.sftpForm.knownHostsDescription")}</FormDescription>
							<FormMessage />
						</FormItem>
					)}
				/>
