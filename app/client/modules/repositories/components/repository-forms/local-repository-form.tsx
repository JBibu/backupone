						...
						<FormControl>
							<div className="flex items-center gap-2">
								...
								<Button
									type="button"
									variant="outline"
									onClick={() => (isTauri() ? setShowPathBrowser(true) : setShowPathWarning(true))}
									size="sm"
								>
						...
						<AlertDialogContent>
							<AlertDialogHeader>
								...
								<AlertDialogDescription className="space-y-3">
									...
									<p className="font-medium">{t("repositories.localForm.warningDescription2")}</p>
									<p className="text-sm text-muted-foreground">
										{t("repositories.localForm.warningDescription3")}{" "}
										<code className="bg-muted px-1 rounded">{REPOSITORY_BASE}</code>
									</p>
								</AlertDialogDescription>
							</AlertDialogHeader>
							<AlertDialogFooter>
					...
					<AlertDialog open={showPathBrowser} onOpenChange={setShowPathBrowser}>
						<AlertDialogContent className="max-w-2xl">
							<AlertDialogHeader>
								...
								<AlertDialogDescription>{t("repositories.localForm.browserDescription")}</AlertDialogDescription>
							</AlertDialogHeader>
							<div className="py-4">
								<DirectoryBrowser
									onSelectPath={(path) => {
