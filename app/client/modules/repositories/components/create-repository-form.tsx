				...
				{watchedIsExistingRepository && (
					<>
						<FormItem>
							...
							<FormDescription>{t("repositories.createForm.password.description")}</FormDescription>
						</FormItem>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>{t("repositories.createForm.password.customDescription")}</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							/>
