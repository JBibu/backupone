							...
							<FormItem>
								...
								<FormControl>
									<Input
										{...field}
										type="email"
										placeholder={t("auth.onboarding.form.emailPlaceholder")}
										disabled={submitting}
									/>
								</FormControl>
							...
							<FormItem>
								...
								<FormControl>
									<Input
										{...field}
										type="text"
										placeholder={t("auth.onboarding.form.usernamePlaceholder")}
										disabled={submitting}
									/>
								</FormControl>
							...
							<FormItem>
								...
								<FormControl>
									<Input
										{...field}
										type="password"
										placeholder={t("auth.onboarding.form.passwordPlaceholder")}
										disabled={submitting}
									/>
								</FormControl>
							...
							<FormItem>
								...
								<FormControl>
									<Input
										{...field}
										type="password"
										placeholder={t("auth.onboarding.form.confirmPasswordPlaceholder")}
										disabled={submitting}
									/>
								</FormControl>
								<FormMessage />
